module RuneRb::World
  class Pathfinder
    ...
    def next_point
      ...
      dx = RuneRb::World::DIRECTION_DELTA_X[p.dir]
      dy = RuneRb::World::DIRECTION_DELTA_Y[p.dir]
      @entity.location = @entity.location.transform(dx, dy, 0)
      p
    end

    def add_step_internal(x, y)
      return if @waypoints.size >= RuneRb::World::MAXIMUM_WAYPOINT_SIZE
